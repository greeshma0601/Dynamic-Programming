...
/*
SOLUTION:In the above problem we will use greedy approach to get the maximum tip earned by the two waiters. Following steps will help in solving this problem:
